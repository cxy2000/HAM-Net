...
class SEFusion(BaseModule):
    ...
    def __init__(self,
        ...
        self.se_img_module = SqueezeAndExcitation3D(out_channels)
        ...
        self.se_module = SqueezeAndExcitation3D(out_channels)
    ...
    def forward(self, img_feats: List[Tensor], pts: List[Tensor],
        ...
        img_pre_fuse = self.se_img_module(img_pre_fuse)
        ...
        fuse_out = self.se_module(fuse_out)
        return fuse_out
